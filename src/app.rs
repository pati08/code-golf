...
use crate::{
    admin::handlers as admin,
    auth::handlers as auth,
    config::Config,
    error::AppError,
    problems::handlers as problems,
    runner::LanguageRegistry,
    scoreboard::handlers as scoreboard,
...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/submissions/{id}/view", get(submissions::get_submission_page))
        .route("/scoreboard", get(scoreboard::get_global_scoreboard))
        .route("/problems/{slug}/scoreboard", get(scoreboard::get_problem_scoreboard))
        // Auth
        ...
        .route("/admin/problems", get(admin::get_admin_problems).post(admin::post_create_problem))
        ...
        .route("/admin/problems/{slug}/publish", post(admin::post_toggle_publish))
        .route("/admin/problems/{slug}/test-cases", get(admin::get_test_cases).post(admin::post_add_test_case))
        .route("/admin/test-cases/{id}/delete", post(admin::post_delete_test_case))
        .route("/admin/submissions", get(admin::get_admin_submissions))
        .route("/admin/users", get(admin::get_admin_users))
        .route("/admin/users/{id}/toggle-admin", post(admin::post_toggle_admin))
        // Static files
